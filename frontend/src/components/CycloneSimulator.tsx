...
import {
  generateDynamicStormPath,
  generateDynamicForecastPath,
...
const CycloneSimulator = () => {
  ...
  const dynamicForecastPath = useMemo(() => {
    ...
    console.log(
      "Generating new forecast path for:",
      currentCyclone.name,
      "with",
      uploadedImages.length,
      "images"
  ...
  const simulationSteps = [
    {
      stage: "Detection",
      description: "TropoScan AI detects initial cloud formation",
      progress: 20,
    },
    {
      stage: "Analysis",
      description: "Deep convection and temperature analysis",
      progress: 40,
    },
    {
      stage: "Classification",
      description: "Risk level assessment and prediction",
      progress: 60,
    },
    {
      stage: "Tracking",
      description: "Trajectory forecast and intensity prediction",
      progress: 80,
    },
    {
      stage: "Complete",
      description: "Full cyclone simulation with forecasts",
      progress: 100,
    },
  ];
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-300">
          Experience how TropoScan detects and forecasts tropical cyclone
          development in real-time. Watch the AI analysis process from initial
          detection to full trajectory prediction.
        </p>
      </div>
        ...
        <CardHeader>
          <CardTitle className="text-white flex items-center justify-between">
            ...
            <div className="flex space-x-2">
              ...
              <Button onClick={resetSimulation} variant="destructive" size="sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-green-900/20 rounded-lg p-4 border border-green-400/30">
              ...
              <div className="text-sm font-bold text-green-400">
                {currentCyclone.lastUpdate.split(" ")[1]}
              </div>
              <div className="text-xs text-gray-400">
                {currentCyclone.lastUpdate.split(" ")[0]}
              </div>
            </div>
          </div>
        </CardContent>
      ...
      {showForecasts && (
        <div className="space-y-6">
          ...
          <h2 className="text-2xl font-bold text-white mb-4">
            Advanced Storm Tracking & Forecasting
          </h2>
          <p className="text-gray-300 mb-6">
            Comprehensive cyclone analysis with trajectory prediction, movement
            tracking, and intensity forecasting
          </p>

          {/* DynamicPathPredictor Component */}
          <div
            key={`dynamic-path-predictor-${selectedCyclone}-${pathRegenerationKey}`}
          >
          ...
          <div
            key={`dynamic-trajectory-forecast-${selectedCyclone}-${pathRegenerationKey}`}
          >
          ...
          <CardContent className="p-6 text-center">
            <div className="flex items-center justify-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">
                  TropoScan AI is analyzing {currentCyclone.name}...
                </p>
              </div>
            </div>
          </CardContent>
